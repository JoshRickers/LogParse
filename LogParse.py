...
parser.add_argument('-t', action='store', dest='time', help='time in format hh:mm')
parser.add_argument('-r', action='store', dest='timeRange', nargs=2, help='Enter two times for to set a range in format hh:mm')
